...
{
    public sealed class VerifoneDeviceDiscovery : IDeviceDiscovery
    {
        public static readonly string VERIFONE_VID = "11ca";
        ...
        public string VID => VERIFONE_VID;
        ...
        private static List<USBDeviceInfo> GetUSBDevices()
        {
            ...
            using (var searcher = new ManagementObjectSearcher(@"Select * From Win32_PnPEntity WHERE ConfigManagerErrorCode = 0"))
            {
                ...
                foreach (var device in collection)
                {
                    ...
                    if (deviceID.Contains("usb\\") && deviceID.Contains($"vid_{VERIFONE_VID}"))
                    {
